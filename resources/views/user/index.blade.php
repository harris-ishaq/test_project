...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ url('user-transactions/list') }}">Riwayat Peminjaman Buku</a></div>
        </div>
    </div>
    <div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-button">
                    <a href="{{ url('user-transactions/create') }}" class="btn btn-lg btn-icon icon-left btn-primary" style="border-radius: 5px !important;"><i class="fas fa-plus-circle"></i> Pinjam Buku</a>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless table-md">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="6"><em>@lang('Belum ada catatan peminjaman.')</em></td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
